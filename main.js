...
//I just copy pasted all the JSON data here so that I can access it without setting up a localhost. The local
//host would always take 30 minutes or so to update, which was annoying.
var data = [{
...
// $.getJSON("data.JSON", function(data) {
    ...
    $.each(data, function(key, val) {
       html += "<tr><td>" + val.name + "</td><td>" + val.description + "</td><td><a href=\"https://www.google.com/maps?q=" + val.location + "\"><button>Open in Google Maps</button></a></td></tr>";
      });
    $("#table").append(html);
     });
// });